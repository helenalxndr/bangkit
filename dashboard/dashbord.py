...
# Load Data (Assume data is in a zip file and needs to be extracted)
with zipfile.ZipFile('data.zip', 'r') as z:
    product_returns = pd.read_csv(z.open('data/product_return.csv'))  # cleaned product return data
    profit = pd.read_csv(z.open('data/profit.csv'))  # cleaned profit data
    coment = pd.read_csv(z.open('data/coment.csv'))  # cleaned low-score comments
    delivery_delay = pd.read_csv(z.open('data/delivery_delay.csv'))  # cleaned delivery delay data
    avg_review_score_per_product = pd.read_csv(z.open('data/average_review_score.csv'))  # cleaned review score data
